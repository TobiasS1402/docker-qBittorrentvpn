...
curl -s -b /tmp/.cookies.txt -c /tmp/.cookies.txt --header "Referer: http://localhost:8080" --data "username=${QBIT_USER}&password=${QBIT_PASS}" http://localhost:8080/api/v2/auth/login
